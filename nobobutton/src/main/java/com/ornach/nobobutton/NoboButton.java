...
public class NoboButton extends LinearLayout {
	...
	private void setupTextView() {
		...
		if (textStyle == 2) {
			textView.setTypeface(Typeface.createFromAsset(context.getAssets() , "fonts/ic_fo2.TTF") ,  Typeface.ITALIC);
		} else if (textStyle == 1) {
			textView.setTypeface(Typeface.createFromAsset(context.getAssets() , "fonts/ic_fo2.TTF") ,  Typeface.BOLD);
		} else {
			textView.setTypeface(Typeface.createFromAsset(context.getAssets() , "fonts/ic_fo2.TTF") ,  Typeface.NORMAL);
		}
